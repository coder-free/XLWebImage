#
#  Be sure to run `pod spec lint XLWebImage.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "zfavourite99" => "zfavourite99@qq.com" }
  # Or just: s.author    = "zfavourite99"
  # s.authors            = { "zfavourite99" => "zfavourite99@qq.com" }
  # s.social_media_url   = "http://twitter.com/zfavourite99"
